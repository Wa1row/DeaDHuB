--[[
 (Dead hub v1) (Discord @ l1xziJJ#5001)
--]]
...
do -- Example UI
	local Window = library:AddWindow("DeaD - HuB By l1xziJJ#5001", {
		main_color = Color3.fromRGB(41, 74, 122),
		min_size = Vector2.new(500, 190),
		toggle_key = Enum.KeyCode.RightControl,
		can_resize = true,
	})
	local Tab = Window:AddTab("l1xziJJ#5001")
	
	

	do -- Elements
        local Slider = Tab:AddSwitch("Fast attack", function(bool)
		 (getgenv()).Config = {
 ["FastAttack"] = bool,
 ["ClickAttack"] = false
} 
...
spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
		...
		local Slider = Tab:AddSlider("HitBox Size (PC only)", function(x)
			_G.SOICE = x
		...
		local Switch = Tab:AddSwitch("Hit-box", function(bool)
			getgenv().HitBox = bool
			spawn(function()
